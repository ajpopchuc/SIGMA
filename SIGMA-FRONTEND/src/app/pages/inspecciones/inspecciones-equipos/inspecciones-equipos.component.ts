...
import { InspeccionesEquiposService, Usuario, Actividad } from './inspecciones-equipos.service';
...
@Component({
  selector: 'app-inspecciones-equipos',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule, NgxPaginationModule, ReactiveFormsModule],
  templateUrl: './inspecciones-equipos.component.html',
  styleUrl: './inspecciones-equipos.component.css'
})
export class InspeccionesEquiposComponent  {
  inspecciones: any[] = [];
  ...
  tipos_actividad = ['Mantenimiento externo', 'Mantenimiento a equipo']; // Ajusta según tus tipos
  usuarios: Usuario[] = []; // Deberías cargar esto desde tu API
  navigation: any;
  constructor(
    private fb: FormBuilder,
    private inspeccionService: InspeccionesEquiposService,
