...
import { Actividad, Usuario, MantenimientoService } from './mantenimiento_equipo.service';
...
@Component({
  selector: 'app-mantenimiento_equipo',
  templateUrl: './mantenimiento_equipo.component.html',
  styleUrls: ['./mantenimiento_equipo.component.css'],
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule, NgxPaginationModule, ReactiveFormsModule]
})
export class MantenimientoEquipoComponent implements OnInit {
  mantenimientos: any[] = [];
