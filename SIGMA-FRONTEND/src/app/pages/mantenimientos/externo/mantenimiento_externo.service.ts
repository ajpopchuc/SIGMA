...
export class MantenimientoService {
  private allUrl = `${API_URL}mantenimientos/externos`;
  ...
  private createUrlCompra = `${API_URL}compras/registerMantenimiento`;
  ...
  createCompra(data: any): Observable<any> {
    ...
    return this.http.post<any>(this.createUrlCompra, data, { headers });
  }
